            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <Header style={{ backgroundColor: 'transparent', elevation: 0.5, height: hp('10%') }}>
                    ...
                    <View style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        <Text style={{ fontSize: 15, color: '#444', textTransform: 'uppercase', fontFamily: 'Poppins-SemiBold' }}>Driver</Text>
                ...
                <Text style={{ fontSize: 15, color: '#444', textTransform: 'uppercase', fontFamily: 'Poppins-SemiBold',paddingHorizontal:15 }}>What went wrong with Jason ?</Text>
