...
import { SafeAreaView, Text, StyleSheet, TouchableOpacity, Dimensions } from 'react-native'
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <Header style={{ backgroundColor: 'transparent', elevation: 0, height: hp('10%') }}>
                    ...
                    <View style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        ...
                        <Text style={{ fontSize: 15, color: '#444', fontFamily: 'Poppins-SemiBold', textTransform: 'uppercase' }}>Terms and Conditions</Text>
                    </View>
                    <Right>
