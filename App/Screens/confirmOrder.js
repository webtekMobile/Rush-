...
import { View, Text, SafeAreaView, StyleSheet, TouchableOpacity, Dimensions,PermissionsAndroid,LogBox, ScrollView, StatusBar, Image, FlatList } from 'react-native'
            ...
            <SafeAreaView style={{ height: hp('100%'), width: wp('100%') }}>
                ...
                <View style={{ flex: 1, backgroundColor: '#fff', elevation: 5, marginTop: '-10%', borderTopRightRadius: 25, borderTopLeftRadius: 25 }}>
                    ...
                    <View style={{ flex: 0.9, justifyContent: 'center', paddingLeft: 15 }}>
                        <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 13, textTransform: 'uppercase' }}>Confirming</Text>
                    ...
                    <View style={{ flex: 0.9 }}>
                        <LinearGradient colors={['#BE1F24', '#FF5355', '#FF7B7B']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.btnStyle]}>
                            <TouchableOpacity onPress={()=>this.props.navigation.navigate('Prepairing')}>
