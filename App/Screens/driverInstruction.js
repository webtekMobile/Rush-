            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <Header style={{ backgroundColor: 'transparent', elevation: 0.5, height: hp('10%') }}>
                    ...
                    <View style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        <Text style={{ fontSize: 15, color: '#444', textTransform: 'uppercase', fontFamily: 'Poppins-SemiBold' }}>Delivery Instructions</Text>
                ...
                <View style={styles.details}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('')}
                        style={styles.btn} >
                        <Text style={styles.detailsTxt}>Leave my delivery with doorman</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.details}>
                    <Icon name="chevron-left" size={24} color="#444" />
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('')}
                        ...
                        <Text style={styles.detailsTxt}>Leave my delivery at main door</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.details}>
                    <Icon name="chevron-left" size={24} color="#444" />
                    <TouchableOpacity style={styles.btn} >
                        ...
                        <Text style={styles.detailsTxt}>Call me when you get to the building</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.details}>
                    <Icon name="chevron-left" size={24} color="#444" />
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('')}
                        ...
                        <Text style={styles.detailsTxt}>Don't ring the door  bell</Text>
                    </TouchableOpacity>
                </View>
